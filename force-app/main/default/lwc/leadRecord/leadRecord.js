...
import fetchLead from '@salesforce/apex/LeadRecord.fetchLeads';
 import deleteSelectedLeads from '@salesforce/apex/LeadRecord.deleteSelectedContacts';
...
export default class LeadRecord extends LightningElement {
    ...
    refreshTable;
    error;
    arrayFields = ['Name','Product__c','Email','Quantity__c', 'Company','Score__c','Phone'];
    @wire(fetchLead)
    leads(result) {
    ...
    deleteRecords() {
        if (this.selectedRecords) {
            ...
            this.isTrue = true;
            deleteSelectedLeads({leadLst: this.selectedRecords }).then(result => {
